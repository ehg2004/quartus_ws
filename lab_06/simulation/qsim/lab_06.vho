...
-- SW_i	=>  Location: PIN_W6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clk	=>  Location: PIN_M8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- RSTN	=>  Location: PIN_M9,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF seq_detector_3bit IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
\D_s[1]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \D_s[1]~1_combout\ = (\gen00:1:ffi0~q\ & ((\gen00:2:ffi0~q\ & ((!\gen00:0:ffi0~q\))) # (!\gen00:2:ffi0~q\ & (!\SW_i~input_o\)))) # (!\gen00:1:ffi0~q\ & (!\SW_i~input_o\ & ((\gen00:0:ffi0~q\))))
...
\D_s[2]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \D_s[2]~2_combout\ = (\gen00:1:ffi0~q\ & (\SW_i~input_o\ & (\gen00:2:ffi0~q\ $ (\gen00:0:ffi0~q\)))) # (!\gen00:1:ffi0~q\ & (!\SW_i~input_o\ & (\gen00:2:ffi0~q\)))
...
\D_s[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \D_s[0]~0_combout\ = (\SW_i~input_o\ & (\gen00:2:ffi0~q\ & (!\gen00:0:ffi0~q\ & \gen00:1:ffi0~q\))) # (!\SW_i~input_o\ & (((\gen00:1:ffi0~q\) # (!\gen00:0:ffi0~q\))))
...
PORT MAP (
	...
	datad => \gen00:1:ffi0~q\,
	combout => \D_s[0]~0_combout\);
