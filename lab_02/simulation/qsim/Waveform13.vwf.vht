...
-- *****************************************************************************
-- Generated on "09/21/2023 20:29:03"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          sumIncvar
-- 
...
ENTITY sumIncvar_vhd_vec_tst IS
END sumIncvar_vhd_vec_tst;
ARCHITECTURE sumIncvar_arch OF sumIncvar_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL Co : STD_LOGIC;
